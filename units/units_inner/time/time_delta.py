...
class TimeDelta:
    ...
    def as_unit(self, unit: Unit) -> float:
        """Get the time difference, expressed as the unit."""
    ...
    def __truediv__(self, other: "float | TimeDelta") -> "TimeDelta | float":
        ...
        - If the argument is scalar, return a time difference scaled by the
          inverse of the value
        - If the argument is a time difference, return the ratio between the two
          differences
        """
