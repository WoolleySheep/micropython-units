...
class Acceleration:
    """the rate of change of the acceleration of an object with respect to time."""
    ...
    def __truediv__(self, other: "float | Acceleration") -> "Acceleration | float":
        ...
        - If the argument is scalar, return an acceleration scaled by the
          inverse of the value
        - If the argument is an acceleration, return the ratio between the two
          accelerations
        """
