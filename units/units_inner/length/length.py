...
class Length:
    ...
    def as_unit(self, unit: Unit) -> float:
        """Get the length, expressed as the unit."""
    ...
    def __sub__(self, other: "Length | LengthDelta") -> "LengthDelta | Length":
        ...
        - If the argument is a length, return the difference between the two
          lengths.
        - If the argument is a length delta, return the length less the
          difference.
        """
        value_as_metre = self.as_unit(Unit.METRE)
