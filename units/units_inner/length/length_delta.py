...
class LengthDelta:
    ...
    def as_unit(self, unit: Unit) -> float:
        """Get the length difference, expressed as the unit."""
    ...
    def __truediv__(self, other: "float | LengthDelta") -> "LengthDelta | float":
        ...
        - If the argument is scalar, return a length difference scaled by the
          inverse of the value
        - If the argument is a length difference, return the ratio between the two
          differences
        """
